...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://cholewa.pro/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("krzysztof.cholewa@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Klopklop14");
