...
public class ForumTestSuite {
    ...
    public void testAddPost(){
        ...
        int postQuantity = forumUser.getPostsQuantity();
    ...
    public void testAddComment() {
        ...
        int commentsQuantity = forumUser.getCommentsQuantity();

        //Then
        Assert.assertEquals(1, commentsQuantity);
    }
    ...
    public void testRemovePost(){
        ...
        //When
        boolean result = forumUser.removePost(thePost);
        int expectedPostQuantity = forumUser.getPostsQuantity();

        //Then
        Assert.assertTrue(result);
        Assert.assertEquals(0, expectedPostQuantity);
    }
    ...
    public void testRemoveComment(){
        ...
        //When
        boolean result = forumUser.removeComment(theComment);
        int expectedCommentQuantity = forumUser.getCommentsQuantity();

        //Then
        Assert.assertTrue(result);
        Assert.assertEquals(0, expectedCommentQuantity);
    }
}
